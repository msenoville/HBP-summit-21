...
%       \node[draw=none,fill=none] at (\paperwidth*0.5,10cm) {\includegraphics[trim=0 23 0 90, clip, width=150cm]{/home/matthieu/Documents/HBP/SP9/logos/HBP_pure.pdf}};
...
\newcommand{\headlineintro}{
	...
	\end{tikzpicture}
	% \begin{tikzpicture}[remember picture,overlay,thick]
	% 	\node[draw=none,fill=none] at (\paperwidth*0.5-0.07cm,0cm) {\includegraphics[trim=0 50 0 189.5, clip, width=1.35\paperwidth]{\imgpath/EBRAINS_circle.pdf}};
	% \end{tikzpicture}
}
...
% 			\end{tikzpicture}	
% 		\end{beamercolorbox}
% 		\hfill \includegraphics[trim=0 0 0 0, clip, width=0.09\paperwidth]{\imgpath/eu_cofunded_logo.png}
...
\newcommand{\footlinetitleslide}{
    ...
    % \phantom{-}\\
    % \phantom{-}\\
	\includegraphics[width=0.11\paperwidth]{\imgpath/HBP_large_2.png} \quad
    \includegraphics[height=24mm]{\imgpath/EBRAINS_all2.pdf} \quad
    ...
    \begin{frame}{}
        ...
        \begin{columns}[t]
            ...
            \column{0.40\textwidth}
                \include{\chappath/intro2machines}
                \vskip-15mm
                \include{\chappath/PyNN_INCF}
                \vskip-15mm
                \include{\chappath/TryIt}

            \column{0.60\textwidth}
                \include{\chappath/Web}
                \vskip-15mm
                \include{\chappath/Jupyter2}
